...
export default function Page() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-indigo-600/80 backdrop-blur-md p-8 border-8 border-black">
      <div className="mt-3 mb-10 border-4 border-black bg-yellow-400 shadow-[8px_8px_0px_rgba(0,0,0,1)] rounded-none p-6">
        <SignUp
          routing="hash"
          appearance={{
            elements: {
